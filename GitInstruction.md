...
### Cоздание **PullRequest-а** *внесение изменений в репозитории находящимся на github.*

==============================================

### Обзор внесенных изменений. Дополнения для просмотра в **VSC**.

 * Внесение изменений для проверки прямой команды `git push`